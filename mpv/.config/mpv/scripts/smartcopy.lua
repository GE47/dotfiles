...
local linux_copy = 'xsel --clipboard < ' --copy command that will be used in Linux. OR write a different command
local linux_paste = 'xsel' --paste command that will be used in Linux. OR write a different command

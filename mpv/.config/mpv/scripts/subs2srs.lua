...
local config = {
    ...
    snapshot_quality = 70,         -- from 0=lowest to 100=highest
    ...
    tie_volumes = true,           -- if set to true, the volume of the outputted audio file depends on the volume of the player at the time of export
    menu_font_size = 25,

    -- Anki
    deck_name = "Sentence Cards",        -- the deck will be created if needed
